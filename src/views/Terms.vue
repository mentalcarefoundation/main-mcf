          ...
          <div class="col-sm-10 col-xs-10 col-sm-offset-1 col-xs-offset-1">
            <article>
              <div class="article__body">
                ...
                carefully.
                <h3 class="mt-10 mb-10 text-uppercase">Using our Services</h3>Don’t misuse or abuse our Services. Don’t interfere with our Services or try to access them in a way other than what we
                provide. You can use our Services only as permitted by law. We may suspend, ban, or stop providing our Services to you if
                you do not follow our policies or terms of service or if we are investigating suspected misconduct.
                <br />
                <br />Using our Services does not give you ownership of any intellectual property rights in our Services or the content you may
                access. You may not use content from our Services unless you have obtained permission from its owner or are otherwise
                permitted by law. These terms do not grant you the right to use any branding or logos from our Services without written
                consent from FITILA. Do not remove, obscure, or alter any legal notices displayed in or along with our Services.
                <br />
                <br />Our Services may display some content that does not belong to FITILA. This content is the sole responsibility of the individual
                who makes it available. We may review content to determine whether it is illegal or violates any of our policies, and we will
                remove or refuse to display content that we believe violates our policies or the law. We do not necessarily review all content,
                do not assume that we do.
                <br />
                ...
                Listener may have been accessed through FITILA, FITILA cannot predict or assess the competence of, or appropriateness for
                your needs, of the professional or other Listener. You also acknowledge and agree that you take full responsibility for the
                decision to access a Listener through the Site and to continue to interact with the Listener, and that the role of FITILA is strictly
                limited to providing access to such Listeners and for your consideration.
                <br />
                <br />Your relationship relating to the Listening Services is strictly with the Listener. We are not involved in any way with the actual
                substance of that relationship or any part of the Listening or Service (whether provided through the Platform or not).
                <br />
                <br />
                <strong>
                ...
                <br />
                <strong>
                  OTHER THAN AS EXPRESSLY SET OUT IN THESE TERMS, NEITHER FITILA NOR ITS AFFILIATES, OFFICERS,
                  DIRECTORS, SHAREHOLDERS, EMPLOYEES, SUB-CONTRACTORS, REPRESENTATIVES, OR AGENTS MAKE ANY
                  COMMITMENTS ABOUT THE CONTENT WITHIN THE SERVICES, THE SPECIFIC FUNCTIONS OF THE SERVICES, OR
                ...
                you reverse engineer or attempt to extract the source code of that software, unless laws prohibit those
                restrictions or you have our written permission. Modifying and Terminating Our Services We are constantly
                changing and improving our Services. We may add or remove functionalities or features, and we may
                suspend or stop a Service altogether.
                <br />
                <br />You can stop using our Services at any time. FITILA may also stop providing Services to you, or add or
                ...
                effective immediately. If you do not agree to the modified terms for a Service, you should immediately
                discontinue your use of that Service.
                <br />
                <br />If there is a conflict between these terms and the additional terms, the additional terms will control for that
                conflict.
                <br />
                <br />These terms control the relationship between FITILA and you. They do not create any third party beneficiary
                rights.
                <br />
                <br />If you do not comply with these terms, and we don’t take action right away, that doesn’t mean that we will
                give up any rights that we may have (such as taking action in the future).
                <br />
                <br />If it turns out that a particular term is not enforceable, this will not affect any other terms. The laws of Nigeria
